...
export const ADMIN_PATH_RULES: ReadonlyArray<{ pattern: RegExp; permission: Permission }> = [
  { pattern: /^\/admin\/admins\/?$/, permission: PERMISSIONS.USERS_MANAGE },
  ...
  { pattern: /^\/admin\/moderators/, permission: PERMISSIONS.USERS_VIEW },
  ...
  { pattern: /^\/admin\/(?:discussions|polls)/, permission: PERMISSIONS.FORUM_VIEW },
  ...
  { pattern: /^\/admin\/(?:orders|invoices|installments|affiliates|dunning|plans|learning-analytics)/, permission: PERMISSIONS.ANALYTICS_VIEW },
  ...
  { pattern: /^\/admin\/(?:languages|api-explorer|system-metrics)/, permission: PERMISSIONS.SETTINGS_VIEW },
...
export const ADMIN_API_RULES: ReadonlyArray<{
  ...
  manage?: Permission;
    ...
    { pattern: /^\/api\/admin\/admins(?:\/|$)/, view: PERMISSIONS.USERS_MANAGE, manage: PERMISSIONS.USERS_MANAGE },
    { pattern: /^\/api\/admin\/security\/sessions\/(?:stats|activity|\d+)/, view: PERMISSIONS.LIVE_MONITOR_VIEW, manage: PERMISSIONS.USERS_MANAGE },
    { pattern: /^\/api\/admin\/security\/logs\/users/, view: PERMISSIONS.USERS_MANAGE, manage: PERMISSIONS.USERS_MANAGE },
    { pattern: /^\/api\/admin\/security\/(?:sessions|logs|fingerprints|roles|ip-whitelist)/, view: PERMISSIONS.SETTINGS_VIEW, manage: PERMISSIONS.SETTINGS_VIEW },
    ...
    { pattern: /^\/api\/admin\/instructors/, view: PERMISSIONS.TEACHERS_VIEW, manage: PERMISSIONS.TEACHERS_MANAGE },
    { pattern: /^\/api\/admin\/live/, view: PERMISSIONS.LIVE_MONITOR_VIEW },
    { pattern: /^\/api\/admin\/analytics/, view: PERMISSIONS.ANALYTICS_VIEW },
    { pattern: /^\/api\/admin\/dunning/, view: PERMISSIONS.ANALYTICS_VIEW },
