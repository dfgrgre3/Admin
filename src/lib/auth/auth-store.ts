...
export function mapApiUserToAuthUser(raw: Record<string, unknown>): AuthUser {
  return {
    ...
    pomodoroSessions: raw.pomodoroSessions as number | undefined,
    deepWorkSessions: raw.deepWorkSessions as number | undefined,
    studyXP: raw.studyXP as number | undefined,
    taskXP: raw.taskXP as number | undefined,
    examXP: raw.examXP as number | undefined,
    challengeXP: raw.challengeXP as number | undefined,
    questXP: raw.questXP as number | undefined,
    seasonXP: raw.seasonXP as number | undefined,
