...
export const PERMISSION_CATEGORIES: PermissionCategory[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: PERMISSIONS.DASHBOARD_ACCESS, label: "الوصول التشغيلي للوحة", description: "الوصول إلى الواجهات التشغيلية للوحة المعلومات", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_KPIS, label: "عرض مؤشرات الأداء", description: "عرض مؤشرات المستخدمين والطلاب والمدرسين الأساسية", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_LEARNING_METRICS, label: "عرض مؤشرات التعلم", description: "عرض التسجيلات والتقدم ووقت الدراسة ومحاولات الاختبارات", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_CONTENT_METRICS, label: "عرض مؤشرات المحتوى", description: "عرض إحصائيات الدورات والامتحانات والواجبات", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_FINANCIAL_METRICS, label: "عرض المؤشرات المالية", description: "عرض الإيرادات والمدفوعات الفاشلة ومتوسط قيمة الطلب", dangerLevel: "elevated" },
      { key: PERMISSIONS.DASHBOARD_VIEW_SUPPORT_METRICS, label: "عرض مؤشرات الدعم", description: "عرض تذاكر الدعم المفتوحة", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_SYSTEM_HEALTH, label: "عرض صحة النظام", description: "عرض حالة الخدمات والبنية التحتية", dangerLevel: "elevated" },
      { key: PERMISSIONS.DASHBOARD_VIEW_RECENT_ACTIVITY, label: "عرض النشاط الحديث", description: "عرض النشاطات الإدارية والتشغيلية الحديثة", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_PENDING_ITEMS, label: "عرض المهام المعلقة", description: "عرض العناصر التي تحتاج تدخل إداري", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_ALERTS, label: "عرض التنبيهات", description: "عرض التنبيهات الحرجة والتشغيلية", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_TOP_COURSES, label: "عرض أفضل الدورات", description: "عرض قائمة الدورات الأكثر نشاطاً", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_EXPORTS, label: "عرض التصديرات", description: "عرض حالة طلبات التصدير", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_VIEW_SENSITIVE, label: "عرض المؤشرات الحساسة", description: "عرض المؤشرات المالية التفصيلية الحساسة", dangerLevel: "dangerous" },
      { key: PERMISSIONS.DASHBOARD_REFRESH_CACHE, label: "تحديث ذاكرة التخزين المؤقت", description: "إجبار اللوحة على إعادة الحساب وتحديث الكاش", dangerLevel: "elevated" },
      { key: PERMISSIONS.DASHBOARD_EXPORT, label: "تصدير بيانات اللوحة", description: "طلب تصدير تقارير اللوحة", dangerLevel: "elevated" },
      { key: PERMISSIONS.DASHBOARD_SAVE_FILTERS, label: "حفظ الفلاتر", description: "حفظ إعدادات الفلترة المخصصة", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_DELETE_SAVED_FILTERS, label: "حذف الفلاتر المحفوظة", description: "حذف الفلاتر المحفوظة", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_APPLY_SAVED_FILTERS, label: "تطبيق الفلاتر المحفوظة", description: "تطبيق فلاتر محفوظة", dangerLevel: "safe" },
      { key: PERMISSIONS.DASHBOARD_ACKNOWLEDGE_ALERTS, label: "إقرار التنبيهات", description: "إقرار وتأكيد التنبيهات لإنهائها", dangerLevel: "elevated" },
      { key: PERMISSIONS.DASHBOARD_MANAGE, label: "إدارة اللوحة", description: "صلاحية شاملة تغطي جميع أقسام اللوحة", dangerLevel: "dangerous" },
