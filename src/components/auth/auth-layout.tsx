...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className={`${inter.className} min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden`}>
      ...
      <div className="z-10 w-full max-w-4xl">
        <div className="text-center mb-10">
          ...
          <p className={`${cairo.className} mt-4 text-gray-400 dark:text-gray-500 font-medium text-lg`}>
        ...
        <p className={`${cairo.className} mt-12 text-center text-sm text-gray-500 dark:text-gray-400 font-bold`}>
