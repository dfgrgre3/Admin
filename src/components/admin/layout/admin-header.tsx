...
const breadcrumbLabels: Record<string, string> = {
  ...
  admins: "المشرفون",
  moderators: "المشرفون الإشرافيون",
  students: "الطلاب",
  progress: "التقدم",
  ...
  questions: "الأسئلة",
  "course-tags": "وسوم الدورات",
  "course-bundles": "حزم الدورات",
  lessons: "الدروس",
  editor: "المحرر",
  preview: "المعاينة",
  ...
  "exam-attempts": "محاولات الامتحانات",
  "anti-cheat": "مكافحة الغش",
  assignments: "الواجبات",
  submissions: "التسليمات",
  "grade-center": "مركز الدرجات",
  feedback: "الملاحظات",
  ...
  assistants: "المساعدون الذكيون",
  moderation: "الرقابة الذكية",
  "content-review": "مراجعة المحتوى",
  logs: "السجلات",
  "api-explorer": "مستكشف API",
  "api-logs": "سجلات API",
  "system-metrics": "مؤشرات النظام",
  profile: "الملف الشخصي",
  "global-activity": "النشاط العام",
