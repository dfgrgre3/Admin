...
export const quickActionsConfig = [
  { id: "broadcast", title: "إرسال بث", description: "إرسال إشعار جماعي" },
  { id: "analytics", title: "التحليلات", description: "عرض الأداء" },
  { id: "reports", title: "التقارير", description: "تنزيل التقارير" },
];
